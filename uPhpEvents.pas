...
begin
  ...
  {$ENDIF}
//ÚÛÚ ÏÓÊÂÚ ·˚Ú¸ ÌÛÊÌ‡ ÔÓ‚ÂÓ˜Í‡ ·˚Î‡, ‡ÏÓÊÂÚ ·˚Ú¸ Ë ÌÂÚ
//ÌÛ ‚˚ ÂÒÎË Û‚Ë‰ÂÚÂ, ÚÓ ÔÂÂ‰‡ÈÚÂ Á‡ÈˆÂ‚Û ÔË‚ÂÚ
{$IFDEF PHP7}
...
{$ENDIF}
  ...
  begin
    ...
    case Args[i - 1].vtype of
      ...
      begin
        ShowMessage('–Â‡ÎËÁÓ‚‡Ú¸ : ' + inttostr(ord(Args[i - 1].vtype)));
...
begin
  ...
  H := EventRun(Sender, 'OnBeforeMenu', [params.GetXCoord, params.GetYCoord,
    // CefStringClearAndGet ‚ÓÚ ‚ ÌÂÈ ıÂÌˇ.!!!
